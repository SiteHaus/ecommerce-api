      ...
      <Tailwind>
        ...
        <Body className="bg-white">
          <Container className="px-3 mx-auto">
            ...
            <Text className="text-[#333] text-sm m-0">{name}, just placed an order!</Text>

            <Link
              href={orderUrl}
              className="inline-block bg-[#333] text-white text-sm font-bold px-4 py-2 rounded mt-4 no-underline"
            >
              View Order
            </Link>
