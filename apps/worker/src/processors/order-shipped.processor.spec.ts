...
import { OrderShippedProcessor } from "./order-shipped.processor";
...
describe("OrderShippedProcessor", () => {
  ...
  it("ignores jobs that are not order.shipped", async () => {
    await processor.process({ name: "order.confirmed", data: {} } as any);
